...
% Reduce the number of decimal places using vpa
a1_vpa = vpa(a1_val, 4);  % 4 significant digits
a2_vpa = vpa(a2_val, 4);  % 4 significant digits

disp('Evaluated acceleration a1 (vpa):');
disp(a1_vpa);
disp('Evaluated acceleration a2 (vpa):');
disp(a2_vpa);
